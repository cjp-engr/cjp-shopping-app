...
test.describe('Product browse — search and filter', () => {
  ...
  test('TC-010: search by keyword filters the product grid', async ({ productListPage }) => {
  ...
  test('TC-011: category filter shows only products from selected category', async ({
    productListPage,
  }) => {
