...
void main() {
  testApp('TC-617: seller deletes simple product from dashboard',
      tags: ['delete-product-simple', 'seller', 'product-delete'], ($, modules) async {
    // Setup
    final api = SellerApiClient();
    await api.login(TestCredentials.sellerEmail, TestCredentials.password);
    final productId = await api.createSimpleProduct('E2E Delete Test Lamp');
